      ...
      <div className="w-full max-w-md flex items-center justify-center">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 shadow-lg bg-[#0F172A]">
          ...
          <div className="bg-white/20 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-white/30">
            <div className="px-8 py-6 bg-white/10">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{ borderColor: errors.email ? '#EF4444' : '#E8DCC8' }}
                  />
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{ borderColor: errors.password ? '#EF4444' : '#E8DCC8' }}
                  />
                  <button
                    type="button"
